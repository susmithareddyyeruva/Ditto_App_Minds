 ...
 */
abstract class BaseDialogFragment : DaggerDialogFragment(), HasAndroidInjector {
    ...
    val bottomNavViewModel: BottomNavViewModel by ViewModelDialogDelegate(ViewModelDialogScope.ACTIVITY)

    val toolbarViewModel: ToolbarViewModel by ViewModelDialogDelegate(ViewModelDialogScope.ACTIVITY)
    val baseViewModel: BaseViewModel by ViewModelDialogDelegate(ViewModelDialogScope.ACTIVITY)
