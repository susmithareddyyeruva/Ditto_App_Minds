    ...
    private fun handleEvent(event: WorkspaceViewModel.Event) =
        when (event) {
            is WorkspaceViewModel.Event.OnNotesClick -> {
                val note: String = viewModel.notes.ifEmpty { viewModel.data.value?.notes ?: "" }
            ...
            is WorkspaceViewModel.Event.SelectLayoutInfo -> {
                Utility.getCommonAlertDialogue(
                    requireActivity(),
                    resources.getString(R.string.empty_string),
                    resources.getString(R.string.select_layout_info_message),
                    resources.getString(R.string.empty_string),
