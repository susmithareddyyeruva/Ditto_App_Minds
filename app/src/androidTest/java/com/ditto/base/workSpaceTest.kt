...
class workSpaceTest :BaseTest() {
    ...
    fun VerifyWorkSpaceUI(){
       ...
       // onView(withId(R.id.coach_mark_popup)).check(matches(isDisplayed()))
        onView(withIndex(withId(R.id.txt_select_all),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_mirror_v),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_mirror_h),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_clear),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_recalibrate),0)).check(matches(withText("Connect"))).check(matches(isDisplayed()))
        onView(withIndex(withId(R.id.txt_tutorial),0)).check(matches(withText("Tutorial"))).check(matches(isDisplayed()))
        onView(withIndex(withId(R.id.txt_instructions),0)).check(matches(withText("Sewing Instructions"))).check(matches(isDisplayed()))
        onView(withIndex(withId(R.id.txt_reset),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.text_complete_pieces),0)).check(matches(withText("0/17"))).check(matches(isDisplayed()))
        onView(withIndex(withId(R.id.button_send_to_projector),0)).check(matches(isDisplayed())).check(matches(not(isEnabled())))
        onView(withIndex(withId(R.id.button_save_and_exit),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_pattern_pieces),0)).check(matches(isDisplayed())).check(matches(isClickable()))
        onView(withIndex(withId(R.id.txt_reeferance_layout),0)).check(matches(isDisplayed())).check(matches(isClickable()))

        onView(RecyclerViewMatcher(R.id.recycler_view_pieces)
    ...
    fun exitWorkspace(){
        ...
        onView(withIndex(withId(R.id.button_save_and_exit),0)).check(matches(isDisplayed())).perform(
            click())
    }
    ...
    fun redirectToInstruction(){
        ...
        onView(withIndex(withId(R.id.header_view_title), 1)).check(matches(withText(R.string.pattern_instructions)))
