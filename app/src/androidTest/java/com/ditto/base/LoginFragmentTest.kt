...
class LoginFragmentTest:BaseTest() {
    ...
    fun verifyUI() {
        ...
        //email hint
        onView(withId(R.id.edittext_username)).check(matches(withHint(R.string.email))).check(matches((isDisplayed())))
        //password hint
        onView(withId(R.id.edittext_password)).check(matches(withHint(R.string.password))).check(matches((isDisplayed())))
        //forgot password
        onView(withId(R.id.text_forgot_password)).check(matches(withText(R.string.forgot_password))).check(matches((isDisplayed())))
        //Login
        onView(withId(R.id.button_login)).check(matches(withText(R.string.login))).check(matches((isDisplayed()))).check(matches((isClickable())))
        //guest preview
        onView(withId(R.id.text_guest_preview)).check(matches(withText(R.string.guest_preview))).check(matches((isDisplayed()))).check(matches((isClickable())))
        //signup
        onView(withId(R.id.tv_signup)).check(matches(withText(R.string.sign_up))).check(matches((isDisplayed()))).check(matches((isClickable())))
    ...
    fun passwordIsEmpty() {
        ...
        onView(withId(R.id.edittext_username)).perform(typeText("email@email.com"), closeSoftKeyboard())
