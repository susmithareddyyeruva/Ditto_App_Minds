...
import com.ditto.menuitems_ui.updateprojector.di.UpdateProjectorFragmentModule
...
@Component(
    modules = [AndroidSupportInjectionModule::class, AppModule::class, LoggerModule::class, LoginDbModule::class,
        ...
        CustomerCareFragmentModule::class,AccountInfoFragmentModule::class, FAQfragmentModule::class, AboutAppFragmentModule::class,UpdateProjectorFragmentModule::class, TokenUsecaseModule::class, TokenApiModule::class,
